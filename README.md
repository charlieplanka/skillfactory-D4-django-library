...
Вы можете авторизоваться двумя способами:
1. Использовать существующий профиль GitHub.
2. Зарегистрировать нового пользователя на странице регистрации.
  
Кнопка входа расположена на главной странице (со списком книг) в правом верхнем углу:
  
![](https://i.imgur.com/1jOP2Yd.png)
  
На странице входа можно выбрать способ авторизации, либо перейти на страницу регистрации.  
Выйти из аккаунта можно на главной странице.
